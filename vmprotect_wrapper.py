...
class VMProtectActivationFlags:
    ACTIVATION_OK = 0x0
    ACTIVATION_SMALL_BUFFER = 0x1
    ACTIVATION_NO_CONNECTION = 0x2
    ACTIVATION_BAD_REPLY = 0x3
    ACTIVATION_BANNED = 0x4
    ACTIVATION_CORRUPTED = 0x5
    ACTIVATION_BAD_CODE = 0x6
    ACTIVATION_ALREADY_USED = 0x7
    ACTIVATION_SERIAL_UNKNOWN = 0x8
    ACTIVATION_EXPIRED = 0x9
    ACTIVATION_NOT_AVAILABLE = 0xA
