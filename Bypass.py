...
class Bypass:
    ...
    def Attack(dll_path, process_name, process_window_name) -> bool:
        ...
        while not isInjected:
            ...
            while not windll.kernel32.OpenProcess(Bypass.PROCESS_ALL_ACCESS, False, dwProcID.value):
                Bypass.Bedge(1000)

            handle = windll.kernel32.OpenProcess(Bypass.PROCESS_ALL_ACCESS, False, dwProcID.value)
